...
function dmca_redirect() {
  $urlku = str_replace(site_url(), '', canonical_url());
  $dmca_check=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM dmca WHERE url='$urlku'");
  
  if(mysqli_num_rows($dmca_check)>0){
